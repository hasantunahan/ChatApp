...
public class User extends FirebaseUserModel {
    ...
    public User(String email, String username, String name, String surname, long dob, String gender, long createdDate, String summInfo, long lastDateOfLogOut, long lastDateOfLogIn, int countOfAnonsDaily, int countOfAllAnons) {
        super(email,username,name,surname,dob,gender,createdDate,summInfo,lastDateOfLogOut,lastDateOfLogIn,countOfAnonsDaily,countOfAllAnons);
    }
    ...
    public FirebaseUserModel getFirebaseModel() {
        return new FirebaseUserModel(getEmail(),getUsername(),getName(),getSurname(),getDob(),getGender(),getCreatedDate(),getSummInfo(),getLastDateOfLogOut(),getLastDateOfLogIn(),getCountOfAnonsDaily(),getCountOfAllAnons());
    }
}
